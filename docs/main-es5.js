      ...
      _createClass(CreateComponent, [{
        ...
        value: function onSubmit(formData) {
          ...
          this.playersService.createPlayer(formData.value).subscribe(function (res) {
            _this2.router.navigateByUrl('/lists');
          });
        }
      }]);
    ...
    var EditComponent = /*#__PURE__*/function () {
      ...
      _createClass(EditComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.id = this.route.snapshot.params['playerId'];
          this.positionsService.getPositions().subscribe(function (data) {
            _this4.positions = data;
          });
          this.playersService.getPlayer(this.id).subscribe(function (data) {
            _this4.player = data;

            _this4.editForm.patchValue(data);
          });
        }
      }, {
        key: "onSubmit",
        value: function onSubmit(formData) {
          ...
          this.playersService.updatePlayer(this.id, formData.value).subscribe(function (res) {
            _this5.router.navigateByUrl('/lists');
          });
        }
      }]);
      ...
      _createClass(ListComponent, [{
        ...
        value: function deletePlayer(id) {
          ...
          this.playersService.deletePlayer(id).subscribe(function (res) {
            _this7.players = _this7.players.filter(function (item) {
              return item.id !== id;
            });
          });
        }
    ...
    var ListsComponent = /*#__PURE__*/function () {
      ...
      _createClass(ListsComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.playersService.getPlayers().subscribe(function (data) {
            _this8.players = data;
            _this8.dataSource = new _angular_material_table__WEBPACK_IMPORTED_MODULE_3__["MatTableDataSource"](data);
